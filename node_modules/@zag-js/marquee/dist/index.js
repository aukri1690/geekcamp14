...
var anatomy = anatomy$1.createAnatomy("marquee").parts("root", "viewport", "content", "edge");
  ...
  return {
    ...
    getContentProps(props2) {
      ...
      return normalize.element({
        ...
        "data-clone": domQuery.dataAttr(clone),
      ...
      trackDimensions({ scope, refs, computed, context, prop }) {
        ...
        const exec = () => {
          ...
          if (rootSize > 0 && contentSize > 0) {
            ...
            const speed = Math.max(1e-3, prop("speed"));
            const multiplier = computed("multiplier");
            const calculatedDuration = prop("autoFill") ? contentSize * multiplier / speed : contentSize < rootSize ? rootSize / speed : contentSize / speed;
